...
describe "Annotated annotate_models rake task and Annotated.set_defaults" do # rubocop:disable RSpec/DescribeClass
  before do
  ...
  describe "with_comment_column" do
    ...
    context 'when Annotate.set_defaults sets it to "true"' do
      before { Annotated.set_defaults("with_comment_column" => "true") }
